  ...
  return (
    <div className="py-24 bg-white/5 backdrop-blur-sm">
      <div className="px-4 mx-auto max-w-3xl">
        <h2 className="text-4xl font-semibold text-center text-zinc-200 mb-16">
          Common Questions
        </h2>
        
        <Accordion type="single" collapsible className="w-full space-y-6">
          <AccordionItem value="cancel" className="border-none hover-card-animation">
            <AccordionTrigger className="text-xl font-medium text-zinc-200 hover:no-underline px-6 py-4 bg-white/10 backdrop-blur-sm rounded-xl">
              Can I cancel my subscription anytime?
            </AccordionTrigger>
            <AccordionContent className="text-zinc-300 text-lg mt-2 px-6">
