  ...
  return (
    <div className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        <h2 className="text-4xl sm:text-5xl font-semibold tracking-tight text-gray-900 mb-16 text-center">
          Common Questions
        </h2>
        ...
        <Accordion type="single" collapsible className="w-full">
          {faqs.map((faq, index) => (
            <AccordionItem key={index} value={`item-${index}`} className="border-b border-zinc-200">
              <AccordionTrigger className="text-lg text-left font-medium text-zinc-900 py-6 hover:no-underline hover:text-[#4169E1]">
                {faq.question}
              </AccordionTrigger>
