        ...
        <div className="mt-12 flex flex-col items-center text-center">
          ...
          <div className="mt-8 flex justify-center gap-3">
            <Button
              ...
              className="text-sm font-medium px-6 py-2 h-12 bg-zinc-900 hover:bg-zinc-800 relative overflow-hidden group rounded-full shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)] transition-all duration-300"
            >
            ...
            <Button
              variant="outline"
              className="text-sm font-medium px-6 py-2 h-12 border-2 border-zinc-200 text-zinc-900 hover:bg-zinc-900 hover:text-white hover:border-zinc-900 transition-colors rounded-full shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] transition-all duration-300"
            >
              Watch Demo
            </Button>
          </div>
