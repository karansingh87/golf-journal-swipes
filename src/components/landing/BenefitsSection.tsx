    ...
    <div className="py-24 bg-zinc-50/30 backdrop-blur-sm">
      <div className="px-4 mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="p-6 bg-white/40 backdrop-blur-sm rounded-2xl shadow-sm hover-card-animation">
            <div className="flex items-center justify-center w-12 h-12 mb-6 bg-zinc-100/50 rounded-xl animate-float">
          ...
          {/* Algorithm Card */}
          <div className="p-6 bg-white/40 backdrop-blur-sm rounded-2xl shadow-sm hover-card-animation">
            <div className="flex items-center justify-center w-12 h-12 mb-6 bg-zinc-100/50 rounded-xl animate-float" style={{ animationDelay: '0.2s' }}>
          ...
          {/* Fair Pay Card */}
          <div className="p-6 bg-white/40 backdrop-blur-sm rounded-2xl shadow-sm hover-card-animation">
            <div className="flex items-center justify-center w-12 h-12 mb-6 bg-zinc-100/50 rounded-xl animate-float" style={{ animationDelay: '0.4s' }}>
