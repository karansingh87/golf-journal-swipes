    ...
    <div className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-lg">
          <div className="rounded-2xl bg-white/80 backdrop-blur-sm p-8 shadow-lg ring-1 ring-zinc-200 hover:shadow-xl transition-shadow duration-300">
            ...
            <Button
              ...
              className="mt-8 w-full text-base py-6 h-auto bg-zinc-900 hover:bg-zinc-800"
            >
