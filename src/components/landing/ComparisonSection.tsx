          ...
          <table className="w-full border-separate border-spacing-0">
            <thead>
              <tr>
                ...
                <th className="px-3 sm:px-6 py-2 sm:py-4 w-1/3">
                  <div className="bg-zinc-950 rounded-t-lg px-6 py-3 -mx-6 -mt-3">
                    <span className="text-sm sm:text-base text-white font-display">GolfLog</span>
                  </div>
                </th>
            ...
            <tbody>
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <td className="px-3 sm:px-6 py-4 sm:py-6 bg-zinc-950/[0.02] shadow-[0_0_0_1px_rgba(0,0,0,0.03)]">
                    {feature.golflog ? (
